...
namespace Illallangi.ShellLink.Sample
{
    public class ShellLinkTest : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // lblCurrentFile
            // 
            this.lblCurrentFile.Font = new System.Drawing.Font(
            ...
            this.Controls.AddRange(
                new System.Windows.Forms.Control[]
                    {
                        this.btnSave, this.btnBrowseIcon, this.btnOpen, this.btnBrowseTarget, this.cboWinStyle,
                        this.txtIconIdx, this.Label6, this.lblHotkey, this.picIcon, this.lblCurrentFile, this.txtTarget,
                        this.txtIconFile, this.txtArgs, this.txtWorkingDir, this.txtDescription, this.Label5, this.Label4,
                        this.Label9, this.Label3, this.Label2, this.Label1, this.Label7
                    });
        ...
        protected void BrowseForFile(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                if (sender.Equals(btnBrowseTarget)) txtTarget.Text = ofd.FileName;
                else txtIconFile.Text = ofd.FileName;
            }
